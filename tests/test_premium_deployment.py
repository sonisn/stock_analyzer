...
def _ow(ticker: str, contracts: int, premium: float, account: str = "Test Account") -> OptionWrite:
    return OptionWrite(
        ticker=ticker,
        account=account,
        strike=200.0,
...
def test_round_lot_summary():
    coverage = {
        ...
        "AAPL": RoundLotCoverage(
            ...
            round_lots=2,
            stub_shares=15,
            stub_dollar_value=3225.0,
            to_next_lot_shares=85,
