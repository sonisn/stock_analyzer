...
def test_parse_rebalance_status_free_text_recognizes_no_action():
    ...
    assert parse_rebalance_status("Status: NO ACTION RECOMMENDED\nReasoning: ...") == "NO_ACTION"
    assert parse_rebalance_status("Status: ACTION RECOMMENDED\nAction 1: SELL TSLA") == "ACTION"
...
def test_parse_picks_regex_fallback_on_free_text():
    ...
    text = "PICK 1: NVDA — AI capex tailwind\nSome prose...\nPICK 2: INTC — foundry turnaround\n"
                ...
                "rows": [
                    {
                        ...
                        "shares": 335,
                        "round_lots": 3,
                        "round_lot_shares": 300,
                        "stub_shares": 35,
                        "stub_dollar_value": 10500.0,
                        "to_next_lot_shares": 65,
